...
def room2blocks(data, label, num_point, block_size=0.40, stride=0.30,
...
def room2blocks_wrapper(data_label_filename, num_point, block_size=0.40, stride=0.30,
                        random_sample=False, sample_num=None, sample_aug=1):
...
def room2blocks_wrapper_normalized(data_label_filename, num_point, block_size=0.40, stride=0.30,
                                   random_sample=False, sample_num=None, sample_aug=1):
    if data_label_filename[-3:] == 'txt':
        data_label = np.loadtxt(data_label_filename)
    elif data_label_filename[-3:] == 'npy':
...
def bbox_label_to_obj(input_filename, out_filename_prefix, easy_view=False):
    ...
    Args:
        ...
        out_filename_prefix: OBJ filename prefix,
            visualize defect by g_label2color
    Returns:
